...
fun compressImage(resolver: ContentResolver,imageUri: String): String {

    val filePath = URI(imageUri).path
...
private fun getRealPathFromURI(resolver:ContentResolver, contentURI: String): String {
